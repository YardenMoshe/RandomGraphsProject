...
@nb.njit(['int64[:,::1](int64[:,::1],int32)','int32[:,::1](int32[:,::1],int32)', 'float64[:,::1](float64[:,::1],int64)'])
...
@nb.njit(['UniTuple(int32, 2)(int32[:,::1],int32)','UniTuple(int64, 2)(int32[:,::1],int32)', 'UniTuple(int64, 2)(float64[:,::1],int32)'])
def getMaximumWeightFromMatrix(input, N):
    max = 0
    tuple = (0, 0)
    for y in range(0, N):
        for x in range(0, N):
